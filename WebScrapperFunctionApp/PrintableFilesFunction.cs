...
//        [Function("PrintableFilesFunctionHttp")]
//        public async Task<IActionResult> PrintableFilesFunctionHttp([HttpTrigger(AuthorizationLevel.Anonymous, "get", "post")] HttpRequest req)
//        {
...
//                int Counter = 0;
//                Console.WriteLine($"Found Printable Files For Processsing {searchResponseprintable.Documents.Count()}");
